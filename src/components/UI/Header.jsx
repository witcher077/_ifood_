  ...
  return (
    <header className='font-[sans-serif] min-h-[60px] tracking-wide relative z-50'>
      <section className="bg-[#004d66]  min-h-[40px] px-4 py-2 sm:px-10 flex items-center max-sm:flex-col">
        ...
        {credential.isLoggedIn === false ? <div className="sm:ml-auto text-white flex">
        ...
        </div> : <div className="sm:ml-auto text-white"><p onClick={Logout} className="text-white text-sm mr-1 cursor-pointer">Log out</p></div>}
      </section>
      ...
      <div className='flex flex-wrap items-center justify-between py-3 px-4 sm:px-10 bg-[#151d20] lg:gap-y-4 gap-y-6 gap-x-4 dark:bg-gray-950'>
        <a href="javascript:void(0)"><img src="https://www.freepnglogos.com/uploads/logo-ifood-png/ifood-food-logo-png-red-transparent-10.png" alt="logo" className='sm:w-[140px] w-[130px]' />
        </a>
        ...
        <div className='flex items-center max-sm:ml-auto'>
          <ul className="flex space-x-4">
            ...
            {credential.isLoggedIn && <li
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" className="cursor-pointer fill-black"
                viewBox="0 0 512 512">
                <path
